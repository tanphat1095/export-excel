...
/**
 * Utility class for extracting data from objects for Excel processing. This class provides methods to extract data from a list of objects,
 * a single object, and to extract fields from a class. The extracted data is used for processing Excel files.
 *
 * @author phatlt
 */
